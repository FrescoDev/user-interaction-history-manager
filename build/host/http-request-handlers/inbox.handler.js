...
var InboxHandler = function (_BaseHandler) {
  _inherits(InboxHandler, _BaseHandler);

  function InboxHandler() {
    _classCallCheck(this, InboxHandler);

    return _possibleConstructorReturn(this, (InboxHandler.__proto__ || Object.getPrototypeOf(InboxHandler)).apply(this, arguments));
  }
